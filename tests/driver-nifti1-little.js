...
import { Utils, isCompressed, decompress, isNIFTI1, readHeader, readImage } from '../src/index';

var buf = readFileSync('./tests/data/little.nii.gz');
...
describe('NIFTI-Reader-JS', function () {
    describe('nifti-1 little endian test', function () {
        ...
        it('littleEndian should be true', function () {
            equal(true, nifti1.littleEndian);
        });
