 ...
 * @returns {boolean}
 */
export function isNIFTI1(data: ArrayBuffer, isHdrImgPairOK = false): boolean {
 ...
 * @returns {boolean}
 */
export function isNIFTI2(data: ArrayBuffer, isHdrImgPairOK = false): boolean {
  var buf, mag1, mag2, mag3;
 ...
 * @returns {boolean}
 */
export function isNIFTI(data: ArrayBuffer, isHdrImgPairOK = false): boolean {
...
export function readExtensionData(
  ...
  const loc = header.getExtensionLocation();
  const size = header.extensionSize;
