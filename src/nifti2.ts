...
import { BaseNIFTI } from "./nifti-base";
import { NiftiExtension } from "./nifti-extension";

export class NIFTI2 extends BaseNIFTI {
  ...
  public toFormattedString(): string {
    ...
    string +=
      ...
      this.getUnitsCodeString(
        nifti.NIFTI1.SPATIAL_UNITS_MASK & this.xyzt_units
      ) +
      ", " +
      this.getUnitsCodeString(
        nifti.NIFTI1.TEMPORAL_UNITS_MASK & this.xyzt_units
      ) +
      ")\n";
